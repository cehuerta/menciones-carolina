...
class Modelomencionesvistas{
    ...
    public function all($start=0, $limit=20, $idm=null, $idsched=null, $id_user=null) 
    {
    ...
    public function contCustom($idm=null, $idsched=null, $id_user=nul, $dia=null, $mention_status=null ) 
    {
        // SI TODOS LOS PARAMETROS ESTAN EN NULL, RETORNAMOS 0
        if($idm===null and $idsched===null and $id_user===null and $dia===null and $mention_status===null )
            return 0;
    ...
    public function contUnreadPreview($idm=null, $schedule_hour=null, $id_user=nul, $dia=null, $mention_status=null, $dia_num=null ) 
    {
        // SI TODOS LOS PARAMETROS ESTAN EN NULL, RETORNAMOS 0
        if($idm===null and $schedule_hour===null and $id_user===null and $dia===null and $mention_status===null and $dia_num===null )
            return 0;
