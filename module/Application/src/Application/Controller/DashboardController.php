...
class DashboardController extends AbstractActionController
{
    ...
    public function dashboardAction()
    {
        ...
        $t_menciones    = $modeloDashboard->totalMenciones(null, null, 1, $idr );
        $t_campanas     = $modeloDashboard->totalCampanas( 1, $idr );
        $t_clientes     = $modeloDashboard->totalClientes( $idr );
        $t_locutores    = $modeloDashboard->totalUsuarios( 3, $idr );
        $readLastDays   = $modeloDashboard->readLastDays( $id_user, $idr );

        //ULTIMAS MENCIONES CREADAS
        $ultimas_menciones      = array();
        $ultimas_menciones_tmp  = $modeloMenciones->all(0,10, null, null, 1, null, null, 'm.idm DESC', null, $idr );
        ...
        $ultimas_menciones_leidas_tmp  = $modeloMencionVista->all(0,10, null, null, $id_user, $idr );
