...
class Modelocampanas{
    ...
    public function all($start=0, $limit=10, $campaign_title=null, $campaign_status=null, $idc=null, $order=null, $like=null, $idr=null) 
    {
        ...
        $select->join(array( 'r'=>'radios'), 'cli.idr=r.idr', array('radio_name'), $select::JOIN_LEFT );
    ...
    public function contCustom($campaign_slug=null, $campaign_title=null, $idc=null, $campaign_status=null, $idr=null ) 
    {
        // SI TODOS LOS PARAMETROS ESTAN EN NULL, RETORNAMOS 0
        if($campaign_slug===null and $campaign_title===null and $idc===null and $campaign_status===null and $idr===null )
            return 0;
